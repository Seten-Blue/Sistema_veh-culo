...
interface Vehiculo { marca: string; modelo: string; anio: string; }
interface Mecanico { nombre: string; apellido: string; }
interface Asignacion { id_mecanico: string; id_vehiculo: string; }
...
export class AppComponent implements AfterViewInit {
  ...
  nuevoMecanico: Mecanico = { nombre: '', apellido: '' };
  nuevaAsignacion: Asignacion = { id_mecanico: '', id_vehiculo: '' };
